...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-white dark:bg-gray-dark">
      {/* Main Footer Content */}
      <div className="border-t border-gray-2 dark:border-gray-700">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0 py-10 lg:py-15">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
            ...
            <div>
              <Link href={`/${locale}`} className="inline-block mb-6">
                <Image
                  src={
                    locale === "ar"
                      ? "/images/logo/logoar.png"
                      : "/images/logo/logoen.png"
                  }
                  alt="Lapip Store"
                  width={120}
                  height={40}
              ...
              <p className="text-dark-5 dark:text-gray-400 mb-6 text-sm leading-relaxed">
                {locale === "ar"
                  ? "متجرك الأول للتسوق الإلكتروني. نقدم أفضل المنتجات بأسعار تنافسية وجودة عالية."
                  : "Your premier online shopping destination. We offer the best products at competitive prices and high quality."}
              </p>
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-dark dark:text-white font-semibold text-base mb-6">
                {t("quickLink")}
              </h3>
              <ul className="space-y-3">
                <li>
                  <Link
                    href={`/${locale}/shop`}
                    className="text-dark-5 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors text-sm"
                  >
                    {t("shop")}
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <a
                    href="mailto:support@lapipstore.com"
                    className="text-dark-5 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors text-sm break-all"
                  >
                    support@lapipstore.com
                  </a>
                </li>
              </ul>
            </div>
