                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search placeholder:text-[#92b18c] placeholder:text-[10px] text-[#92b18c] text-[11px] w-full  lg:rounded-r-[5px] bg-gray-1  lg:!border-l-0 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                    />
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative w-full">
                        ...
                        <input
                          ...
                          placeholder={t("searchPlaceholder")}
                          autoComplete="off"
                          className="custom-search text-[#92b18c] placeholder:text-[#92b18c] placeholder:text-[10px] text-[11px] w-full rounded-r-[5px] bg-gray-1 !border-l-0 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200"
                        />
