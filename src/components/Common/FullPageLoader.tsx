...
const FullPageLoader: React.FC<FullPageLoaderProps> = ({
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 z-[999999] flex h-screen w-screen items-center justify-center bg-white overflow-hidden"
        role="status"
        ...
        <div className="relative flex flex-col items-center justify-center">
          ...
          <div className="relative h-48 w-48 mb-8">
            ...
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 z-10">
              <div className="w-6 h-16 bg-gradient-to-t from-slate-700 to-slate-500 rounded-lg shadow-xl">
                <div className="w-6 h-2 bg-blue-500 rounded-t-lg shadow-lg shadow-blue-500/50 animate-pulse"></div>
              </div>
            </div>
            ...
            {[...Array(6)].map((_, i) => (
              ...
              >
                <div
                  className="w-20 h-20 rounded-full blur-xl opacity-80"
                  style={{
            ...
            {[...Array(3)].map((_, i) => (
              ...
              >
                <div
                  className="w-12 h-12 rounded-full blur-lg opacity-60"
                  style={{
                    background:
          ...
          <div className="text-center space-y-3 z-20">
            <h2 className="text-3xl font-bold text-slate-800 tracking-wider animate-pulse">
              {t("loading")}
            </h2>
          ...
          <div className="mt-6 flex justify-center space-x-2">
            {[...Array(3)].map((_, i) => (
              <div
                key={`dot-${i}`}
                className={`w-2 h-2 bg-blue-500 rounded-full pulse-dot-${i}`}
              ></div>
            ))}
          </div>
        </div>
